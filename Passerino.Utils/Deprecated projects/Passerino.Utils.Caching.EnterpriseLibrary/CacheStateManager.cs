...
namespace Passerino.Utils.Caching.EnterpriseLibrary
{
    ...
    {
        private const string SERIALIZATION_INFO_IDENTIFIER = "state";
        ...
        {
            DeserializeState(information.GetString(SERIALIZATION_INFO_IDENTIFIER));
        }
        ...
        {
            info.AddValue(SERIALIZATION_INFO_IDENTIFIER, ToString());
        }
