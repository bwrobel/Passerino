...
{
    public interface IStructureMapConfigManager : IConfigurationValidator
    {
        void Initialize();
    }

    public class StructureMapConfigManager : IStructureMapConfigManager
    {
        ...
        public static bool AssemblyIsIoCVisible(Assembly assembly)
        {
        ...
        private void InitializeAllApplicationRegistries()
        {
            ...
            {
                scan.AssembliesFromPath(Environment.CurrentDirectory, AssemblyIsIoCVisible);
